...
#   curl -sL https://raw.githubusercontent.com/nipegun/ot-scripts/refs/heads/main/Ataques/Raspberry-GPIO-PLC-ForzarEncendidoDePin.sh | bash -s IPDestino
#
# Ejecución remota como root (para sistemas sin sudo):
#   curl -sL https://raw.githubusercontent.com/nipegun/ot-scripts/refs/heads/main/Ataques/Raspberry-GPIO-PLC-ForzarEncendidoDePin.sh | sed 's-sudo--g' | bash -s IPDestino
#
# Bajar y editar directamente el archivo en nano
#   curl -sL https://raw.githubusercontent.com/nipegun/ot-scripts/refs/heads/main/Ataques/Raspberry-GPIO-PLC-ForzarEncendidoDePin.sh | nano -
# ----------
